...
<div class='bug_card'>
<h2>Unblockable Illari ult</h2>
<p>When Illari ultimate hits Doomfist and the Doomfist is dealt sufficient damage, the ultimate “blows up”. Every single interaction doomfist has with abilities that stick to the player behave the same way - you can block them. You can block echo bombs, tracer ultimate, etc.

But Illari’s ultimate detonation, for some reason, works differently. The ultimate can only be blocked if the player is facing to the positive X vector, which is certainly not something an average player is aware about. This is better shown in the video.</p></div>
