...
bug_report:
    - https://us.forums.blizzard.com/en/overwatch/t/doomfist-meteor-strike-camera-bug/988214
...
As of 12/07/26, the camera issue is now also present on moving targets with complex geometry, such as payloads. For now the issue has only been discovered on the map Rialto, but it may also be present on other maps.
